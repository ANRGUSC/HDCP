...
/**
 * [add_packet_to_recent_packets description]
...
/**
 * [recv_from_broadcast description]
 * @param c    [description]
...
/*---------------------------------------------------------------------------*/
/**
 * [sent_from_broadcast description]
 * @param c             [description]
 * @param status        [description]
 * @param transmissions [description]
 */
...
//	if(OWNDEBUG1)
	...
	if((bcp_conn->current_packet->hdr).origin_seq_no==packetbuf_attr(PACKETBUF_ATTR_PACKET_ID)) //check 1. TODO: Add source check
	{
		...
		if(i != NULL) 
		{
			...
			// {
			// 	//PRINTF("bcp: ERROR: delay_timer expired.\n");
			// }
...
/**
 * [retransmit_callback description]
 * @param ptr [description]
 */
static void retransmit_callback(void *ptr)
{
...
/*---------------------------------------------------------------------------*/
/**
 * [send_ack description]
 * @param bc     [description]
 * @param to     [description]
 * @param from   [description]
 * @param seq_no [description]
 */
static void send_ack(struct bcp_conn *bc, const rimeaddr_t *to, const rimeaddr_t *from, uint16_t seq_no)
{
	// if(tx_flag)
